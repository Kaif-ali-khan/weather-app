...
const dataFetch = () => {
  load.innerHTML = `<div class="spinner-border" style="width: 3rem; height: 3rem;" role="status">
  ...
  overflow: hidden;  display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical;">
    ...
    .catch(() => {
      ...
      <div class="" style="height: 400px; width: 400px;">
          ...
          <h1 class="text-center fs-3 p-3">Something went wrong</h1>
          <div class="text-center">
              <button type="button" class="btn btn-primary" onclick="dataFetch()">Try Again</button>
            </div>
      </div>
  </div>`;
    });
